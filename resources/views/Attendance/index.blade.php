...
<a href="{{ route('attendance.create')}}">[+ Add New]</a>
<table border="1">
    <thead>
        <tr>
            <th>Tanggal</th>
            ...
            <tr>
                ...
                <td style="vertical-align:top">
                    <span class="badge" style="vertical-align:top; margin-top:5px;">
                        <span class="badge-key">{{$arr_ibadah[$attd->ibadah_id]['ibadah_name']}}</span><span class="badge-value-primary">{{$attd->ibadah_name}}</span>
                    </span>    
                ...
                <td style="text-align:center;">
                    ...
                    <a href="{{route('attendance.adjust',['sermon_date' => $attd->sermon_date, 'ibadah_id' => $attd->ibadah_id])}}">[ Edit ]</a>
                </td>

        ...
        <table border="1" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" id="marriage_date" name="marriage_date" maxlength="100" required>
                    </td>
                </tr>
                <tr>
                    <td>Nama Pasangan</td>
                    <td>
                        <input type="text" id="spouse_name" name="spouse_name" maxlength="100" required>
                    </td>
                </tr>
            </tbody>
        </table>        
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <select id="member_type" name="member_type" required>
                            <option value="appraisal">Jemaat Tetap</option>
                            <option value="listed">Partisipan</option>
                        </select>
                    </td>
                </tr>
                <tr>

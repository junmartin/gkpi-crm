        ...
        <table border="1" width="100%">
            ...
            <tbody>                
                ...
                <tr>
                    ...
                    <td style="width:50%;">
                        <input type="text" id="pic" name="pic" maxlength="100" value="{{$asset->pic}}" disabled>
                    </td>
                </tr>
                <tr>
                    <td style="width:50%;">Ownership<br><small>(leave blank if belong to Church)</small></td>
                    <td style="width:50%;">
                        <input type="text" id="ownership" name="ownership" maxlength="100" value="<?php echo (empty($asset->ownership)) ? "GKPI-GP" : $asset->ownership;?>" disabled>
                    </td>
                </tr>
            </tbody>
            <thead>
                ...
                <tr>
                    <td height="300" style="vertical-align:top;">
                        ...
                        <ul>
                            ...
                            @endforeach    
                            <li>
                                <a href="{{route('asset_maint.create.with_param',$asset->id)}}">[ + Add New Maintenance ]</a>
                            </li>                        
                        </ul>
                    </td>
                </tr>
